  ...
  class _SettingsPageState extends State<SettingsPage> {
    ...
    // 🔥 THE FIX: Decide if text should be black or white based on theme brightness
  final Color contrastColor = ThemeData.estimateBrightnessForColor(themeColor) == Brightness.dark 
                ...
                children: [
                  if (user == null) ...[
                    ...
                    ElevatedButton.icon(
                      ...
                      label:  Text("LOG IN", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: contrastColor)),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: themeColor, 
                        foregroundColor: contrastColor,// 👈 Changed from indigo
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 24, backgroundColor: themeColor,
                    ...
                    if (!settings.isBetaApproved) ...[
                      ElevatedButton.icon(
                        ...
                        label: Text(_isRequesting ? "SENDING..." : "REQUEST BETA ACCESS", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: themeColor)),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: themeColor.withValues(alpha: 0.1), // 👈 Changed from indigo
      foregroundColor: themeColor, // 👈 Changed from indigo
      ...
      if (user != null && isApproved) ...[
        _buildAiWallet(isDark, user.uid, themeColor), // 🔥 FIX: Add themeColor here
    const SizedBox(height: 12),
      ],
                Stack(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildSliderLabel("Basic", settings.aiCreativity <= 0.3, isDark, themeColor),
  _buildSliderLabel("Standard", settings.aiCreativity > 0.3 && settings.aiCreativity < 0.8, isDark, themeColor),
  _buildSliderLabel("Deep", settings.aiCreativity >= 0.8, isDark, themeColor),
                                ],
                              ),
                              const SizedBox(height: 12),
            ...
            _buildSystemCard(
              ...
              isDark: isDark,
              theme: themeColor, // 🔥 FIX: Pass themeColor
              trailing: Switch(
    ...
    Widget _buildSliderLabel(String text, bool isActive, bool isDark, Color theme) => 
    Text(text, style: TextStyle(
      fontSize: 9, 
      fontWeight: isActive ? FontWeight.bold : FontWeight.normal, 
      color: isActive ? theme : (isDark ? Colors.white24 : Colors.grey[400])
    ));
  ...
  Widget _buildSystemCard({
    ...
    required Color theme, // 👈 Just this
    Widget? trailing, 
    VoidCallback? onTap
  }) {
      return InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(icon, color: isDark ? Colors.white70 : theme, size: 20), // 👈 Changed from indigo
              const SizedBox(width: 16),
              Expanded(
      ...
      Widget _buildAiWallet(bool isDark, String uid, Color theme) {
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation<Color>(
                          remaining < (maxTokens * 0.1) ? Colors.redAccent : theme,
                        ),
                      ),
                    ),
                    const SizedBox(height: 8),
  ...
  Widget _buildDangerZone(BuildContext context) {
    ...
    Color _getThemeColor(String theme) {
      switch (theme.toLowerCase()) {
        ...
        case 'indigo': return const Color(0xFF4338CA);
        case 'emerald': return const Color(0xFF047857);
        default: return const Color(0xFF047857);
      }
    }
